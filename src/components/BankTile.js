...
export default function BankTile({ animal, color, onSelect }) {
  return (
    <div
      onClick={onSelect}
      className="aspect-square bg-blue-800 m-1 border-blue-800 rounded-md border-2 flex justify-center items-center p-1 md:p-1.5 overflow-hidden"
    >
